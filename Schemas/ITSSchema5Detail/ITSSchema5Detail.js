define("ITSSchema5Detail", ["ConfigurationEnums"], function(configurationEnums) {
	return {
            ...
            openApplicationLookup: function() {
                ...
                esq.getEntityCollection(function(result) {
                    ...
                    if (existsDocumentsCollection.length > 0) {
                        ...
                        config.filters.add(existsFilter);
                    }
                    config.filters.add("competitorFilter", this.Terrasoft.createColumnFilterWithParameter(
                    	this.Terrasoft.ComparisonType.EQUAL, "ITSCompetitor", false));

define("ITSSchema2Detail", ["ConfigurationEnums"], function(configurationEnums) {
	return {
		...
		diff: /**SCHEMA_DIFF*/[
			{
                ...
                "values": {
                    "rowDataItemMarkerColumnName": "ITSIndustry"
                }
            },
		...
		methods: {
            ...
            getGridDataColumns: function() {
                return {
                    "Id": {path: "Id"},
                    "Industry": {path: "ITSIndustry"},
                    "Industry.Name": {path: "ITSIndustry.Name"}
                };
            },
            ...
            openApplicationLookup: function() {
                ...
                esq.addColumn("ITSIndustry.Id", "IndustryId");
                ...
                esq.getEntityCollection(function(result) {
                    ...
                    if (result.success) {
                        result.collection.each(function(item) {
                            existsDocumentsCollection.push(item.get("IndustryId"));
                        });
                    }
            ...
            getDocumentInsertQuery: function(item) {
                ...
                insert.setParameterValue("ITSIndustry", item.IndustryId, this.Terrasoft.DataValueType.GUID);
                return insert;
            },
